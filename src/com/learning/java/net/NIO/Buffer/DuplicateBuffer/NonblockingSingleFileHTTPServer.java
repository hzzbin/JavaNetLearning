package com.learning.java.net.NIO.Buffer.DuplicateBuffer;
...
/**
 * Created by binzhang213309 on 2018/1/13.
 */
public class NonblockingSingleFileHTTPServer {
    ...
    public static void main(String[] args) {
        if (args.length == 0) {
            System.out.println(
                    "Usage: jave NonblockingSingleFileHTTPServer file port encoding"
            );
            return;
        }
